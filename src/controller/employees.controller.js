...
export const AUTHemployees = {
  async register(req, res, next) {
    try {
      ...
      const admin = await Employees.findBy('role', 'admin');
  ...
  async verifyUser(req, res, next) {
    try {
      ...
      await Employees.update(UserExist.id, {
        status: 'active',
  ...
  async deleteProfile(req, res, next) {
    try {
      ...
      const deletedUser = await Employees.delete(userId);
